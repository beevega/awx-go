...
type Organization struct {
	...
	DefaultEnvironment interface{} `json:"default_environment"`
}
...
// ListInventories represents `ListInventories` endpoint response.
...
// ListJobTemplates represents `ListJobTemplates` endpoint response.
type ListJobTemplates struct {
	Pagination
...
// ListHosts represents `ListHosts` endpoint response.
